...
INSERT INTO `service_call` (`id`, `address_id`, `problem_id`, `solution_id`, `problem_description`, `date_created`, `date_scheduled`, `completed`, `total_cost`, `estimate`, `hours_labor`, `contractor_notes`, `business_id`, `user_id`, `customer_rating`, `customer_rating_comment`) VALUES (12, 1, 10, 11, 'Water leaking from boiler.', '2022-01-21', '2022-02-28', 0, 45.60, 1, 4, NULL, 1, 2, 4, 'gave it a four');
...
INSERT INTO `service_call` (`id`, `address_id`, `problem_id`, `solution_id`, `problem_description`, `date_created`, `date_scheduled`, `completed`, `total_cost`, `estimate`, `hours_labor`, `contractor_notes`, `business_id`, `user_id`, `customer_rating`, `customer_rating_comment`) VALUES (14, 2, 12, 11, 'Install of new A/C unit at back of property.', '2022-01-16', '2022-02-22', 0, 70, 0, 8, NULL, 1, 2, 4, 'gave it a four');
...
INSERT INTO `service_call` (`id`, `address_id`, `problem_id`, `solution_id`, `problem_description`, `date_created`, `date_scheduled`, `completed`, `total_cost`, `estimate`, `hours_labor`, `contractor_notes`, `business_id`, `user_id`, `customer_rating`, `customer_rating_comment`) VALUES (20, 2, 3, 11, 'Hot water not coming on for upstairs shower.', '2022-01-05', '2022-02-06', 1, 54.26, 0, 8, NULL, 2, 2, 4, 'gave it a four');
INSERT INTO `service_call` (`id`, `address_id`, `problem_id`, `solution_id`, `problem_description`, `date_created`, `date_scheduled`, `completed`, `total_cost`, `estimate`, `hours_labor`, `contractor_notes`, `business_id`, `user_id`, `customer_rating`, `customer_rating_comment`) VALUES (21, 2, 16, 11, 'My rear property unit is not running.', '2022-01-04', '2022-02-07', 1, 66, 0, 5, NULL, 2, 2, 4, 'gave it a four');
