...
INSERT INTO `service_call` (`id`, `address_id`, `problem_id`, `solution_id`, `problem_description`, `date_created`, `date_scheduled`, `completed`, `total_cost`, `estimate`, `hours_labor`, `contractor_notes`, `business_id`, `user_id`, `customer_rating`, `customer_rating_comment`) VALUES (5, 2, 3, 11, 'Only cold water running out of all sinks.', '2022-01-05', '2022-02-06', 1, 54.26, 0, 8, NULL, 2, 2, 4, 'gave it a four');
